...
int main()
{
    ...
    for(i = 1;i <= rows;i++)
    {
        ...
        for(spaces = 1; spaces <= (((4*rows)-(4*jj-2))-1);spaces++) //sapces
        {
            printf(" ");
        }
    ...
    for(i = 1;i <= rows;i++)
    {
        ...
        for(spaces = 1; spaces <= (((4*rows)-(4*i-2))-1);spaces++) //sapces
        {
            printf(" ");
        }
...
User            Date              Brief
******************************************************************************************
Sameh         13Feb2023-12:57PM                Added hollow Diamond inside a rectangle
*/